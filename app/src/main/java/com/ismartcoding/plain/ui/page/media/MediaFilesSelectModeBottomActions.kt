            ...
            PIconTextActionButton(
                ...
                click = {
                    DialogHelper.confirmToDelete {
                        ...
                        when (viewModel) {
                            is com.ismartcoding.plain.ui.models.ImagesViewModel -> viewModel.delete(context, tagsViewModel, dragSelectState.selectedIds.toSet())
                            is com.ismartcoding.plain.ui.models.VideosViewModel -> viewModel.delete(context, tagsViewModel, dragSelectState.selectedIds.toSet())
                            is com.ismartcoding.plain.ui.models.AudioViewModel -> viewModel.delete(context, tagsViewModel, dragSelectState.selectedIds.toSet())
                        }
                        dragSelectState.exitSelectMode()
                    }
                }
